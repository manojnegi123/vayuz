<?php
// Register 'Icon WP Recent Posts' widget
add_action( 'widgets_init', 'init_iconwp_recent_posts' );
if ( ! function_exists( 'init_iconwp_recent_posts' ) ) {
	function init_iconwp_recent_posts() { return register_widget('iconwp_recent_posts'); }
}

class iconwp_recent_posts extends WP_Widget {
	/** constructor */
	function iconwp_recent_posts() {
		parent::__construct( 'iconwp_recent_posts', $name = 'Icon WP Recent Post' );
	}
		...
		<li class="clearfix">
            ...
            <?php if ( $instance['display_featured_image'] && has_post_thumbnail() ) {?>
                    <a href="<?php the_permalink() ?>" title="<?php echo esc_attr(get_the_title() ? get_the_title() : get_the_ID()); ?>">
                        <?php the_post_thumbnail('iconwp-widget-post-thumb', array('class' => 'widget-thumb')); ?>
                    </a>
