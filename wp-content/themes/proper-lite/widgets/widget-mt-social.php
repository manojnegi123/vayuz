...
class proper_lite_social extends WP_Widget {
	
// constructor

    function proper_lite_social() {

		$widget_ops = array('classname' => 'proper_lite_social_widget', 'description' => esc_html__( 'Drag this widget to the Social Widget Area.', 'proper-lite') );

        parent::__construct(false, $name = esc_html__('MT - Social Icons', 'proper-lite'), $widget_ops);

		$this->alt_option_name = 'proper_lite_social_widget';
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id('social_fb_link')); ?>"><?php esc_html_e('Facebook URL:', 'proper-lite'); ?></label>
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id('social_twitter_link')); ?>"><?php esc_html_e('Twitter URL:', 'proper-lite'); ?></label>
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id('social_linked_link')); ?>"><?php esc_html_e('LinkedIn URL:', 'proper-lite'); ?></label>
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id('social_google_link')); ?>"><?php esc_html_e('Google URL:', 'proper-lite'); ?></label>
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id('social_instagram_link')); ?>"><?php esc_html_e('Instagram URL:', 'proper-lite'); ?></label>
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id('social_flickr_link')); ?>"><?php esc_html_e('Flickr URL:', 'proper-lite'); ?></label>
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id('social_pinterest_link')); ?>"><?php esc_html_e('Pinterest URL:', 'proper-lite'); ?></label>
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id('social_youtube_link')); ?>"><?php esc_html_e('Youtube URL:', 'proper-lite'); ?></label>
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id('social_vimeo_link')); ?>"><?php esc_html_e('Vimeo URL:', 'proper-lite'); ?></label>
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id('social_tumblr_link')); ?>"><?php esc_html_e('Tumblr URL:', 'proper-lite'); ?></label>
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id('social_dribbble_link')); ?>"><?php esc_html_e('Dribbble URL:', 'proper-lite'); ?></label>
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id('social_rss_link')); ?>"><?php esc_html_e('RSS URL:', 'proper-lite'); ?></label>
	...
	<label for="<?php echo sanitize_text_field( $this->get_field_id( 'social_url_path' )); ?>"><?php esc_html_e( 'Check this box to open links in a new window.', 'proper-lite' ); ?></label>
	...
	function update($new_instance, $old_instance) { 
		...
		if ( isset($alloptions['proper_lite_social']) )

			delete_option('proper_lite_social');		  
	...
	function flush_widget_cache() {
		...
		wp_cache_delete('proper_lite_social', 'widget');
	...
	function widget($args, $instance) {
		...
		if ( ! $this->is_preview() ) {
			...
			$cache = wp_cache_get( 'proper_lite_social', 'widget' );
...
?>
	...
	<?php
		...
		if ( ! $this->is_preview() ) {
			...
			wp_cache_set( 'proper_lite_social', $cache, 'widget' ); 
